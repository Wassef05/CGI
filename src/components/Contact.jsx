    ...
    <div id="contact" className="relative pt-20 sm:pt-10 max-w-screen">
      ...
      <div className="relative mt-10 sm:mt-16 w-full bg-white">
        ...
        <div className="relative max-w-screen mx-auto p-6 md:grid md:grid-cols-2 md:gap-12 z-10">
          ...
          <div className="bg-[#3C3C3C]/80 rounded-3xl p-6 px-6 sm:px-8 text-white md:my-auto max-w-md mx-auto sm:ml-0 md:text-left ">
          ...
          <div className="bg-white/70 rounded-xl p-6 sm:p-8 text-[#3B4862] md:pr-12 py-10 mt-8 md:mt-0 md:text-left text-center">
